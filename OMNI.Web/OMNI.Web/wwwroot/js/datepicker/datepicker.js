! function (t) {
    ...
    function t(t, e) {
        return function () {
            return e !== V && x.fn.datepicker.deprecated(e), this[t].apply(this, arguments)
        }
    }

    function k(t, e) {
        x.data(t, "datepicker", this), this._events = [], this._secondaryEvents = [], this._process_options(e), this.dates = new i, this.viewDate = this.o.defaultViewDate, this.focusDate = null, this.element = x(t), this.isInput = this.element.is("input"), this.inputField = this.isInput ? this.element : this.element.find("input"), this.component = !!this.element.hasClass("date") && this.element.find(".add-on, .input-group-addon, .input-group-append, .input-group-prepend, .btn"), this.component && 0 === this.component.length && (this.component = !1), this.isInline = !this.component && this.element.is("div"), this.picker = x(N.template), this._check_template(this.o.templates.leftArrow) && this.picker.find(".prev").html(this.o.templates.leftArrow), this._check_template(this.o.templates.rightArrow) && this.picker.find(".next").html(this.o.templates.rightArrow), this._buildEvents(), this._attachEvents(), this.isInline ? this.picker.addClass("datepicker-inline").appendTo(this.element) : this.picker.addClass("datepicker-dropdown dropdown-menu"), this.o.rtl && this.picker.addClass("datepicker-rtl"), this.o.calendarWeeks && this.picker.find(".datepicker-days .datepicker-switch, thead .datepicker-title, tfoot .today, tfoot .clear").attr("colspan", function (t, e) {
            return Number(e) + 1
    ...
    k.prototype = {
        ...
        _check_template: function (t) {
            try {
                return t !== V && "" !== t && ((t.match(/[<>]/g) || []).length <= 0 || 0 < x(t).length)
            } catch (t) {
                return !1
            }
        },
        _process_options: function (t) {
            ...
            if (s = x.grep(s, function (t) {
                ...
                if (1 === s.length) switch (s[0]) {
                    ...
                    case "right":
                        e.orientation.x = s[0]
                } else n = x.grep(s, function (t) {
                    return /^left|right$/.test(t)
                }), e.orientation.x = n[0] || "auto", n = x.grep(s, function (t) {
                    return /^top|bottom$/.test(t)
                }), e.orientation.y = n[0] || "auto";
            else;
            if (e.defaultViewDate instanceof Date || "string" == typeof e.defaultViewDate) e.defaultViewDate = N.parseDate(e.defaultViewDate, a, e.language, e.assumeNearbyYear);
            else if (e.defaultViewDate) {
                var o = e.defaultViewDate.year || (new Date).getFullYear(),
                    r = e.defaultViewDate.month || 0,
                    h = e.defaultViewDate.day || 1;
                e.defaultViewDate = S(o, r, h)
            } else e.defaultViewDate = F()
        },
        _applyEvents: function (t) {
            for (var e, i, a, s = 0; s < t.length; s++) e = t[s][0], 2 === t[s].length ? (i = V, a = t[s][1]) : 3 === t[s].length && (i = t[s][1], a = t[s][2]), e.on(a, i)
        },
        _unapplyEvents: function (t) {
            for (var e, i, a, s = 0; s < t.length; s++) e = t[s][0], 2 === t[s].length ? (a = V, i = t[s][1]) : 3 === t[s].length && (a = t[s][1], i = t[s][2]), e.off(i, a)
        },
        ...
        paste: function (t) {
            var e;
            if (t.originalEvent.clipboardData && t.originalEvent.clipboardData.types && -1 !== x.inArray("text/plain", t.originalEvent.clipboardData.types)) e = t.originalEvent.clipboardData.getData("text/plain");
            else {
        ...
        place: function () {
            ...
            if ("auto" === p && (p = -s + u - e < 0 ? "bottom" : "top"), this.picker.addClass("datepicker-orient-" + p), "top" === p ? u -= e + parseInt(this.picker.css("padding-top")) : u += l, this.o.rtl) {
                var f = a - (c + d);
                this.picker.css({
                    top: u,
                    right: f,
        ...
        update: function () {
            ...
            }, this)), e = !0) : (i = (i = this.isInput ? this.element.val() : this.element.data("date") || this.inputField.val()) && this.o.multidate ? i.split(this.o.multidateSeparator) : [i], delete this.element.data().date), i = x.map(i, x.proxy(function (t) {
        ...
        fillMonths: function () {
            for (var t = this._utc_to_local(this.viewDate), e = "", i = 0; i < 12; i++) e += '<span class="month' + (t && t.getMonth() === i ? " focused" : "") + '">' + A[this.o.language].monthsShort[i] + "</span>";
        ...
        _fill_yearsView: function (t, e, i, a, s, n, o) {
            ...
            }), m = p - c; m <= f + c; m += c) r = [e], h = null, m === p - c ? r.push("old") : m === f + c && r.push("new"), -1 !== x.inArray(m, D) && r.push("active"), (m < s || n < m) && r.push("disabled"), m === g && r.push("focused"), o !== x.noop && ((l = o(new Date(m, 0, 1))) === V ? l = {} : "boolean" == typeof l ? l = {
                enabled: l
            } : "string" == typeof l && (l = {
                classes: l
            }), !1 === l.enabled && r.push("disabled"), l.classes && (r = r.concat(l.classes.split(/\s+/))), l.tooltip && (h = l.tooltip)), d += '<span class="' + r.join(" ") + '"' + (h ? ' title="' + h + '"' : "") + ">" + m + "</span>";
        ...
        fill: function () {
            var t, e, i = new Date(this.viewDate),
                ...
                l = A[this.o.language].today || A.en.today || "",
                d = A[this.o.language].clear || A.en.clear || "",
                c = A[this.o.language].titleFormat || A.en.titleFormat,
                u = F(),
                p = (!0 === this.o.todayBtn || "linked" === this.o.todayBtn) && u >= this.o.startDate && u <= this.o.endDate && !this.weekOfDateIsDisabled(u);
            if (!isNaN(s) && !isNaN(a)) {
                this.picker.find(".datepicker-days .datepicker-switch").text(N.formatDate(i, c, this.o.language)), this.picker.find("tfoot .today").text(l).css("display", p ? "table-cell" : "none"), this.picker.find("tfoot .clear").text(d).css("display", !0 === this.o.clearBtn ? "table-cell" : "none"), this.picker.find("thead .datepicker-title").text(this.o.title).css("display", "string" == typeof this.o.title && "" !== this.o.title ? "table-cell" : "none"), this.updateNavArrows(), this.fillMonths();
                var f = S(s, a, 0),
                    g = f.getUTCDate();
                f.setUTCDate(g - (f.getUTCDay() - this.o.weekStart + 7) % 7);
                var D = new Date(f);
                f.getUTCFullYear() < 100 && D.setUTCFullYear(f.getUTCFullYear()), D.setUTCDate(D.getUTCDate() + 42), D = D.valueOf();
                for (var m, y, v = []; f.valueOf() < D;) {
                    if ((m = f.getUTCDay()) === this.o.weekStart && (v.push("<tr>"), this.o.calendarWeeks)) {
                        var w = new Date(+f + (this.o.weekStart - m - 7) % 7 * 864e5),
                            k = new Date(Number(w) + (11 - w.getUTCDay()) % 7 * 864e5),
                            b = new Date(Number(b = S(k.getUTCFullYear(), 0, 1)) + (11 - b.getUTCDay()) % 7 * 864e5),
                            _ = (k - b) / 864e5 / 7 + 1;
                        v.push('<td class="cw">' + _ + "</td>")
                    ...
                    this.o.beforeShowDay !== x.noop && ((e = this.o.beforeShowDay(this._utc_to_local(f))) === V ? e = {} : "boolean" == typeof e ? e = {
                        ...
                        classes: e
                    }), !1 === e.enabled && y.push("disabled"), e.classes && (y = y.concat(e.classes.split(/\s+/))), e.tooltip && (t = e.tooltip), e.content && (C = e.content)), y = x.isFunction(x.uniqueSort) ? x.uniqueSort(y) : x.unique(y), v.push('<td class="' + y.join(" ") + '"' + (t ? ' title="' + t + '"' : "") + ' data-date="' + f.getTime().toString() + '">' + C + "</td>"), t = null, m === this.o.weekEnd && v.push("</tr>"), f.setUTCDate(f.getUTCDate() + 1)
                }
                this.picker.find(".datepicker-days tbody").html(v.join(""));
                var T = A[this.o.language].monthsTitle || A.en.monthsTitle || "Months",
                    M = this.picker.find(".datepicker-months").find(".datepicker-switch").text(this.o.maxViewMode < 2 ? T : s).end().find("tbody span").removeClass("active");
                if (x.each(this.dates, function (t, e) {
                    e.getUTCFullYear() === s && M.eq(e.getUTCMonth()).addClass("active")
                }), (s < n || r < s) && M.addClass("disabled"), s === n && M.slice(0, o).addClass("disabled"), s === r && M.slice(h + 1).addClass("disabled"), this.o.beforeShowMonth !== x.noop) {
                    var U = this;
                    x.each(M, function (t, e) {
                        var i = new Date(s, t, 1),
                            a = U.o.beforeShowMonth(i);
                        a === V ? a = {} : "boolean" == typeof a ? a = {
                            enabled: a
                        } : "string" == typeof a && (a = {
                            classes: a
                        }), !1 !== a.enabled || x(e).hasClass("disabled") || x(e).addClass("disabled"), a.classes && x(e).addClass(a.classes), a.tooltip && x(e).prop("title", a.tooltip)
                    })
                }
                this._fill_yearsView(".datepicker-years", "year", 10, s, n, r, this.o.beforeShowYear), this._fill_yearsView(".datepicker-decades", "decade", 100, s, n, r, this.o.beforeShowDecade), this._fill_yearsView(".datepicker-centuries", "century", 1e3, s, n, r, this.o.beforeShowCentury)
            }
        },
        ...
        navArrowsClick: function (t) {
            ...
            0 !== this.viewMode && (e *= 12 * N.viewModes[this.viewMode].navStep), this.viewDate = this.moveMonth(this.viewDate, e), this._trigger(N.viewModes[this.viewMode].e, this.viewDate), this.fill()
        },
        ...
        setViewMode: function (t) {
            this.viewMode = t, this.picker.children("div").hide().filter(".datepicker-" + N.viewModes[this.viewMode].clsName).show(), this.updateNavArrows(), this._trigger("changeViewMode", new Date(this.viewDate))
        }
    };

    function l(t, e) {
        x.data(t, "datepicker", this), this.element = x(t), this.inputs = x.map(e.inputs, function (t) {
            return t.jquery ? t[0] : t
        }), delete e.inputs, this.keepEmptyValues = e.keepEmptyValues, delete e.keepEmptyValues, s.call(x(this.inputs), e).on("changeDate", x.proxy(this.dateUpdated, this)), this.pickers = x.map(this.inputs, function (t) {
            ...
            if (h.shift(), this.each(function () {
                ...
                if (!e) {
                    var a = function (t, e) {
                        ...
                        for (var o in e = new RegExp("^" + e.toLowerCase()), i) e.test(o) && (a[o.replace(s, n)] = i[o]);
                        return a
                    }(this, "date"),
                        s = function (t) {
                            var i = {};
                        ...
                        }(x.extend({}, d, a, i).language),
                        n = x.extend({}, d, s, a, i);
                    e = t.hasClass("input-daterange") || n.inputs ? (x.extend(n, {
                        inputs: n.inputs || t.find("input").toArray()
                    }), new l(this, n)) : new k(this, n), t.data("datepicker", e)
                }
                "string" == typeof o && "function" == typeof e[o] && (r = e[o].apply(e, h))
            }), r === V || r instanceof k || r instanceof l) return this;
    ...
    var A = x.fn.datepicker.dates = {
        ...
        N = {
            ...
            parseDate: function (t, e, i, a) {
                ...
                if ("string" == typeof e && (e = N.parseFormat(e)), e.toValue) return e.toValue(t, e, i);
                var s, n, o, r, h, l = {
                    d: "moveDay",
                    m: "moveMonth",
                    w: "moveWeek",
                ...
                if (t in d && (t = d[t]), /^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/i.test(t)) {
                    for (s = t.match(/([\-+]\d+)([dmwy])/gi), t = new Date, r = 0; r < s.length; r++) n = s[r].match(/([\-+]\d+)([dmwy])/i), o = Number(n[1]), h = l[n[2].toLowerCase()], t = k.prototype[h](t, o);
                    return k.prototype._zero_utc_time(t)
                }
                s = t && t.match(this.nonpunctuation) || [];
                var c, u, p = {},
                ...
                g.yy = g.yyyy, g.M = g.MM = g.mm = g.m, g.dd = g.d, t = F();
                var D = e.parts.slice();

                function m() {
                    var t = this.slice(0, s[r].length),
                        e = s[r].slice(0, t.length);
                    return t.toLowerCase() === e.toLowerCase()
                }
                if (s.length !== D.length && (D = x(D).filter(function (t, e) {
                    return -1 !== x.inArray(e, f)
                }).toArray()), s.length === D.length) {
                    var y, v, w;
                    for (r = 0, y = D.length; r < y; r++) {
                        if (c = parseInt(s[r], 10), n = D[r], isNaN(c)) switch (n) {
                            case "MM":
                                u = x(A[i].months).filter(m), c = x.inArray(u[0], A[i].months) + 1;
                                break;
                            case "M":
                                u = x(A[i].monthsShort).filter(m), c = x.inArray(u[0], A[i].monthsShort) + 1
                        }
                        p[n] = c
                    }
                    for (r = 0; r < f.length; r++)(w = f[r]) in p && !isNaN(p[w]) && (v = new Date(t), g[w](v, p[w]), isNaN(v) || (t = v))
                }
                return t
            },
            formatDate: function (t, e, i) {
                if (!t) return "";
                if ("string" == typeof e && (e = N.parseFormat(e)), e.toDisplay) return e.toDisplay(t, e, i);
                var a = {
                    d: t.getUTCDate(),
                ...
                for (var s = x.extend([], e.separators), n = 0, o = e.parts.length; n <= o; n++) s.length && t.push(s.shift()), t.push(a[e.parts[n]]);
                return t.join("")
            },
